...
import DonutInnerText from './DonutInnerText.js';
...
export default class DonutChart extends Component {
    ...
    */
    ...
    render() {
        const { startAngle, width, height, formatValues, className,
              data, legend, emptyColor, strokeColor, colors,
              colorFunction, innerRadius, outerRadius, emptyOffset,
              selectedOffset, toggledOffset } = this.props;
